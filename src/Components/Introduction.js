			...
			<Container>
                <Row>
                  ...
                  <Col xs = {8} className="align-self-center">
					...
					<p> In my spare time, I like to play video games, go hiking, workout, or play the guitar. I'm also a huge foodie, so I love exploring new cusines and tasting all sorts of exotic foods. </p>
